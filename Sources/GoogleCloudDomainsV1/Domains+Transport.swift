  ...
  class DomainsTransport: DomainsStub {
    ...
    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://domains.googleapis.com")
    }
    ...
    public func searchDomains(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDomainsV1.SearchDomainsResponse.self, from: data)
    }
    ...
    public func retrieveRegisterParameters(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDomainsV1.RetrieveRegisterParametersResponse.self, from: data)
    }
    ...
    public func retrieveTransferParameters(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDomainsV1.RetrieveTransferParametersResponse.self, from: data)
    }
    ...
    public func listRegistrations(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDomainsV1.ListRegistrationsResponse.self, from: data)
    }
    ...
    public func getRegistration(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDomainsV1.Registration.self, from: data)
    }
    ...
    public func retrieveAuthorizationCode(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDomainsV1.AuthorizationCode.self, from: data)
    }
