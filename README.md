# Google Cloud Client Libraries for Swift - Cloud Domains API
...
Add `swift-google-cloud-domains-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-domains-v1.git --from 0.1.0-preview
```

Then add `GoogleCloudDomainsV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudDomainsV1 <target-name> --package swift-google-cloud-domains-v1
```
